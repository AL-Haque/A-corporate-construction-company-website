            ...
            <div class="col-md-7 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{route('user.store',$users->id)}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" name="role" value="{{$users->role}}"
                                    class="form-control" style="padding: .500rem"
                    ...
                    <div class="card-body">
                        <div class="col-sm-3" style="max-width: 20%;padding-bottom:20px">
                            ...
                            <div class="col-sm-2" style="position: relative">
                                ...
                                <img id="img-preview" src="{{ asset('images/'.$users->image) }}" width="220rem"
                                height="150rem"/>
