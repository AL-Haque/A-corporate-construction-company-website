            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action=" {{ route('slider.store','$slid->id') }}"
                            ...
                            {{-- <div class="form-group row">
                                ...
                                height="150px"  style="margin-left: 17.5rem" />
                            </div> --}}
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <img id="img-preview" src="{{ asset('images/noimage.jpg') }}" width="220px"
                            height="150px" style="padding-top:1rem;padding-left:1.1rem"/>
                        </div>
