            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('client.update', $clients->id)}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" value="{{$clients->name }}" class="form-control"
                                        style="padding: .500rem" id="exampleInputUsername1" placeholder="Enter Client Name">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3" style="max-width: 20%; padding-top:10px">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="tag_line" value="{{ $clients->tag_line }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                        ...
                                        <textarea class="form-control form-control-sm" name="details" style="padding: .500rem" name="description"
                                            id="editor" cols="20" rows="4">{!!$clients->details!!}</textarea>
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <img id="img-preview" src="{{ asset('images/client/' . $clients->image) }}" width="220rem"
                            height="150rem"/>
